...
Once you open RStudio, take some time to explore the interface. Then we'll dive into details.
...
Jupyter Lab is a popular alternative to RStudio. It is less tailored to R, but is used in many especially industry settings. If you would like to try it out, see setup instructions [here](https://github.com/christophergandrud/hu-live-coding-course-examples/blob/main/src/jupyter-lab-setup.md).

### Markdown

[Markdown](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet) is a [markup language](https://en.wikipedia.org/wiki/Markup_language) widely used in data science to format human readable documents, especially interspersed with code. It is used in both [RMarkdown](https://rmarkdown.rstudio.com/) (how these materials are created) and Jupyter Lab.
...
- [RStudio Primers](https://rstudio.cloud/learn/primers/1.2) (objects through lists).
