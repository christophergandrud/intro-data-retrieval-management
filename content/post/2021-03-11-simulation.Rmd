...
Ok, we've found the a typo. We should have used `i` instead of `u` to index the output of `one_sim`. Are we done? We'll let's check the output:
...
And $Z$ is also a cause of $X$. \$\\epsilon\$
