...
Note `rnorm()` simulates data from the normal distribution. For `parLapply()` we need to first create a cluster with `cl <- makeCluster(cores = 2)` (for 2 cores) and then run the function.
