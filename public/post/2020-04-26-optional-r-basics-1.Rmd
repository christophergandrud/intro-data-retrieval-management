...
You can do this in the cloud on the course's **Posit [RStudio] cloud** site:
...
especially interspersed with code. It is used in
[RMarkdown](https://rmarkdown.rstudio.com/) (how these materials are
created), [Quarto (a more expansive RMarkdown)](https://quarto.org/), and Jupyter Lab. 
