...
library(xfun)
pkg_attach2("tidyverse", "jsonlite", "janitor")
...
Example data from [Wikipedia](https://en.wikipedia.org/wiki/JSON#Example).
...
**Indentation** is not required, but helps us see the nesting structure.
...
Now use your R data manipulation tools to convert the parse JSON data to the R format you need for your analysis. 
