...
Sweeney's insights has led to new areas of data management like [differential privacy](https://www.johndcook.com/blog/2018/11/06/what-is-differential-privacy/). 
...
```{dot struct-to-unstruct, echo=FALSE, cache=TRUE}
...
What are the privacy and protection considerations you should make with the ~3 data sets you identified?