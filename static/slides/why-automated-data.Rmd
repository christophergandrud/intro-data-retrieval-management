...
⚠️ While automated data retrieval and management is more important than ever
...
- ⚠️ **Never store** credentials in non-secure locations (e.g. use a password manager with command line access)
