...
`Describe automation task -> ChatGPT -> Run/Debug and Modify Request -> ChatGPT -> Run/Debug and Modify (including refactor), etc.`

&#x2753; **Do we need to learn to code anymore?**

-   Yes. LLMs are amazing. But they mess up a lot. 

-   To be effective, you need to **understand** their output and be **able to ask** informative debugging questions.
