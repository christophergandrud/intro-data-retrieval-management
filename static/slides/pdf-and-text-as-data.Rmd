...
Use the [pdftools](https://docs.ropensci.org/pdftools/) package to parse PDFs in R.

⚠️ This package should be easier to install than [tabulizer](https://github.com/ropensci/tabulizer) which requires [rJava](https://cran.r-project.org/web/packages/rJava/index.html). This can be a real pain to install. See [tabulizer README](https://github.com/ropensci/tabulizer/README.md). However, tabulizer is more powerful for extracting tables from PDF docs.
